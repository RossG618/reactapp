...
const itemNum = () => {
  ...
  return (
    <div className="d-flex align-items-center justify-content-around bg-dark h-75">
      <div><Clock/></div>
      ...
      <NavLink className='nav-link rounded text-white ' to="/" exact>Home</NavLink>
        ...
        <Dropdown.Menu>
         ...
         <NavLink className='nav-link' to="/lamborghini">Lamborghini</NavLink>
          ...
          <NavLink className='nav-link nav-item text-white' to="/about">About</NavLink>
          <NavLink className='nav-link nav-item text-white' to="/articles">Articles</NavLink>
          <NavLink className='nav-link nav-item text-white' to="/categories">Categories</NavLink>
          <NavLink to="/colors-api" className='full-rotate text-white'>
