...
<Modal show={show} style={{transform: "translate(0%, 20%)", backgroundImage: "https://albantsh.co.uk/wp-content/uploads/2021/09/feedback-4746811_1920-1030x687.png"}} className='d-flex flex-row'>
    <Modal.Header closeButton onClick={handleClose}>
            <Modal.Title className="" style={{opacity: "0.8"}}>Please give us your feedback</Modal.Title>
        </Modal.Header>
